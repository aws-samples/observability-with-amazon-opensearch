...
.awsui-motion-disabled .awsui_dimmed_10ipo_1pmg0_93:not(#\9), .awsui-mode-entering .awsui_dimmed_10ipo_1pmg0_93:not(#\9) {
  animation: none;
  transition: none;
}
...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_root_10ipo_1pmg0_120:not(#\9) {
  /* stylelint-disable-next-line plugin/no-unsupported-browser-features */
  border-collapse: separate;
  border-spacing: 0;
  caption-side: top;
...
.awsui_list_10ipo_1pmg0_131:not(#\9) {
  display: flex;
  margin: 0;
  padding: 0;
  list-style: none;
...
.awsui_list_10ipo_1pmg0_131 > .awsui_list-item_10ipo_1pmg0_138:not(#\9) {
  display: inline-flex;
