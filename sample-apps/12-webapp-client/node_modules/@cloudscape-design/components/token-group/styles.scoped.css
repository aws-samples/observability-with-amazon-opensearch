...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_root_dm8gx_1kw6u_97:not(#\9) {
...
.awsui_dismiss-button_dm8gx_1kw6u_123[data-awsui-focus-visible=true]:not(#\9):focus {
  position: relative;
}
.awsui_dismiss-button_dm8gx_1kw6u_123[data-awsui-focus-visible=true]:not(#\9):focus {
...
.awsui_dismiss-button_dm8gx_1kw6u_123[data-awsui-focus-visible=true]:not(#\9):focus::before {
  content: " ";
  display: block;
  position: absolute;
  left: calc(-1 * 0px);
...
.awsui_toggle_dm8gx_1kw6u_172:not(#\9) {
  /* stylelint-disable-next-line plugin/no-unsupported-browser-features */
  border-collapse: separate;
  border-spacing: 0;
  caption-side: top;
...
.awsui-motion-disabled .awsui_toggle_dm8gx_1kw6u_172:not(#\9), .awsui-mode-entering .awsui_toggle_dm8gx_1kw6u_172:not(#\9) {
  animation: none;
  transition: none;
}
